...
public class AdminController {
	...
	public ResultConstant savePromotionSetting(@RequestBody String productPromotionJson,
												@RequestBody String productItemShowJson) {
	...
	public ResultConstant updateProductItem(@RequestBody(required = true) String itemNo,
											@RequestBody(required = true) String itemName, 
											@RequestBody(required = true) String itemDesc) {
	...
	public ResultConstant addProductItem(@RequestBody(required = true) String itemName, 
										@RequestBody(required = true) String itemDesc,
										@RequestBody(required = false) String parentItemNo) {
	...
	public ResultConstant deleteProductItem(@RequestBody(required=true) String itemNo) {
