...
public class JedisClusterUtils {  
    ...
    public static Set<String> getKeys(String pattern) {  
    	Set<String> keys = cacheUtils.redisTemplate.keys(pattern); 
    	return keys;
    }  
   ...
   public static long getExpire(String key) {  
    return	cacheUtils.redisTemplate.getExpire(key,TimeUnit.MINUTES);
   }  
    ...
    public static <T> Long lpush(String key, T value) {  
    	...
    	if (value instanceof String) {
    		return cacheUtils.redisTemplate.opsForList().leftPush(key, value.toString());  
    	}
     ...
     * @param val 
     */  
    public static Set<String> getSetDatas(String key) {  
     ...
     * @param val 
     */  
    public static Long removeSetValue(String key,String values) {  
